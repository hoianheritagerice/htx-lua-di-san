...
const MA_NONG_DAN = {
  ...
  CKOD: {
    'TRẦN CƯỚC': 'CUOC',
    'NGUYỄN HỘ': 'HO',
    'TÔ VĂN HƯNG': 'HUNG',        // 19/08/2026: đổi lại từ Nguyễn Thị Mừng (MUNG)
    'NGUYỄN SÔ': 'NGSO',          // ⚠ trùng với TRẦN SỞ — sửa theo Notion
    'TRẦN ĐÌNH CHÍNH': 'CHINH',   // 19/08/2026: đổi lại từ Nguyễn Thị Sáu (SAU)
